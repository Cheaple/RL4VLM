...
deepspeed --include localhost:4,5,6,7 \
    ...
    --version v1 \
    --data_path ~/yule-tx/sft-data/blackjack/blackjack.json \
    --image_folder ~/yule-tx/sft-data/blackjack/blackjack_data_folder \
    ...
    --bf16 True \
    --output_dir ~/yule-tx/models/llava-v1.6-mistral-7b-bj-sft \
    --num_train_epochs 1 \
